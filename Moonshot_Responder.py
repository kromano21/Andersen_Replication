...
def run(id, stakes_value, wealth_value, model_value, temperature_value, framing_value, proportion_value, human_emphasis):
    #Gemini Set-up
    global id_counter
    global proposals
    global responses
    ...
    for i in range(proposer_sample_size):
        ...
        individual_list.append("February")
    ...
    aggregate_individual_list.append("February")
...
#OpenAI setup
client = OpenAI(api_key='', base_url= "https://api.moonshot.cn/v1") #Insert API Key Here
...
def main():
    ...
    #run(id_counter, 20, 493, "Moonshot-Kimi", 1, 1, 0.1, 1)
