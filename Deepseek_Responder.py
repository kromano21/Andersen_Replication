...
def run(id, stakes_value, wealth_value, model_value, temperature_value, framing_value, proportion_value, human_emphasis):
    ...
    for p in proposals:
        ...
        get_ai_response(responder_prompt, model_value, "Responses_Deepseek.txt")
        reasoning_counter += 1
                
    int_responder_average = average_responses("Responses_Deepseek.txt")
    os.remove("Responses_Deepseek.txt")
...
def chat_with_gpt(prompt):
    ...
    try:
        ...
        reasoning_return.write(str_reasoning_counter + '. ' + reasoning_content + '\n \n \n')
...
def main():
    ...
    #run(id_counter, 20, 493, "Deepseek-Reasoner", 1, 1, 0.1, 2)
