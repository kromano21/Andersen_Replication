...
id_counter = 1
master_list = []
column_list = ["Proposal", "ID", "Stakes", "Wealth", "Model", "Proportion", "Temperature", "Month"]
master_list.append(column_list)
aggregate_master_list = [] 
aggregate_column_list = ["ID", "Model", "Stakes (Rupees)", "Wealth (Rupees)", "Temperature", "Month", "Prop_Avg (Rupees)", "Avg_Per_of_Stake", "Num_of_Zero_Offers", "Prop_SE", "Prop_CI_95_L", "Prop_CI_95_H", "Prop_Errors", "Framing"]
...
def main():
    ...
    #run(id_counter, 20, 493, "Moonshot-Kimi", 1, 1, 0)
